...
_PHRASES: tuple[tuple[str, str], ...] = (
    ...
    ("plave order", "place order"),
    ("place me the order", "place order"),
    ("place me", "place order"),
    ("place oder", "place order"),
    ("the roder", "the order"),
    ("the irder", "the order"),
    ("give me irder", "give me order"),
    ("search fr ", "search for "),
    ("existing adress", "existing address"),
    ("existng address", "existing address"),
    ("exisiting address", "existing address"),
    ("saved adress", "saved address"),
    ("savd address", "saved address"),
    ("palce order", "place order"),
    ("plase order", "place order"),
    ...
    ("mera order", "my order"),
    ("check irders", "check orders"),
    ("i placed", "i placed"),
    ("iplaced", "i placed"),
    ("i palced", "i placed"),
    ("order iplaced", "order i placed"),
    ("check oder", "check orders"),
    ("check oders", "check orders"),
    ("wapas karna", "return"),
    ("wapsi", "return"),
    ("vaapas", "return"),
